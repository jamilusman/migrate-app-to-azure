...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="jamilusman@udacity-postgres-db", password="32Jumras@62", host="udacity-postgres-db.postgres.database.azure.com")
